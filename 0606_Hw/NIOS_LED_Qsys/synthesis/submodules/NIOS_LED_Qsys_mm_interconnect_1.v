// NIOS_LED_Qsys_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module NIOS_LED_Qsys_mm_interconnect_1 (
	...
	wire  [11:0] sw_s1_agent_m0_address;                                                         // SW_s1_agent:m0_address -> SW_s1_translator:uav_address
	...
	wire  [86:0] sw_s1_agent_rf_source_data;                                                     // SW_s1_agent:rf_source_data -> SW_s1_agent_rsp_fifo:in_data
	...
	wire  [86:0] sw_s1_agent_rsp_fifo_out_data;                                                  // SW_s1_agent_rsp_fifo:out_data -> SW_s1_agent:rf_sink_data
	...
	wire  [85:0] cmd_mux_002_src_data;                                                           // cmd_mux_002:src_data -> SW_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                          // SW_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                        // cmd_mux_002:src_channel -> SW_s1_agent:cp_channel
	...
	wire  [11:0] led_s1_agent_m0_address;                                                        // LED_s1_agent:m0_address -> LED_s1_translator:uav_address
	...
	wire  [86:0] led_s1_agent_rf_source_data;                                                    // LED_s1_agent:rf_source_data -> LED_s1_agent_rsp_fifo:in_data
	...
	wire  [86:0] led_s1_agent_rsp_fifo_out_data;                                                 // LED_s1_agent_rsp_fifo:out_data -> LED_s1_agent:rf_sink_data
	...
	wire  [85:0] cmd_mux_003_src_data;                                                           // cmd_mux_003:src_data -> LED_s1_agent:cp_data
	...
	wire  [31:0] timer_10ms_s1_agent_m0_readdata;                                                // timer_10ms_s1_translator:uav_readdata -> timer_10ms_s1_agent:m0_readdata
	wire         timer_10ms_s1_agent_m0_waitrequest;                                             // timer_10ms_s1_translator:uav_waitrequest -> timer_10ms_s1_agent:m0_waitrequest
	wire         timer_10ms_s1_agent_m0_debugaccess;                                             // timer_10ms_s1_agent:m0_debugaccess -> timer_10ms_s1_translator:uav_debugaccess
	wire  [11:0] timer_10ms_s1_agent_m0_address;                                                 // timer_10ms_s1_agent:m0_address -> timer_10ms_s1_translator:uav_address
	wire   [3:0] timer_10ms_s1_agent_m0_byteenable;                                              // timer_10ms_s1_agent:m0_byteenable -> timer_10ms_s1_translator:uav_byteenable
	wire         timer_10ms_s1_agent_m0_read;                                                    // timer_10ms_s1_agent:m0_read -> timer_10ms_s1_translator:uav_read
	wire         timer_10ms_s1_agent_m0_readdatavalid;                                           // timer_10ms_s1_translator:uav_readdatavalid -> timer_10ms_s1_agent:m0_readdatavalid
	wire         timer_10ms_s1_agent_m0_lock;                                                    // timer_10ms_s1_agent:m0_lock -> timer_10ms_s1_translator:uav_lock
	wire  [31:0] timer_10ms_s1_agent_m0_writedata;                                               // timer_10ms_s1_agent:m0_writedata -> timer_10ms_s1_translator:uav_writedata
	wire         timer_10ms_s1_agent_m0_write;                                                   // timer_10ms_s1_agent:m0_write -> timer_10ms_s1_translator:uav_write
	wire   [2:0] timer_10ms_s1_agent_m0_burstcount;                                              // timer_10ms_s1_agent:m0_burstcount -> timer_10ms_s1_translator:uav_burstcount
	wire         timer_10ms_s1_agent_rf_source_valid;                                            // timer_10ms_s1_agent:rf_source_valid -> timer_10ms_s1_agent_rsp_fifo:in_valid
	wire  [86:0] timer_10ms_s1_agent_rf_source_data;                                             // timer_10ms_s1_agent:rf_source_data -> timer_10ms_s1_agent_rsp_fifo:in_data
	wire         timer_10ms_s1_agent_rf_source_ready;                                            // timer_10ms_s1_agent_rsp_fifo:in_ready -> timer_10ms_s1_agent:rf_source_ready
	wire         timer_10ms_s1_agent_rf_source_startofpacket;                                    // timer_10ms_s1_agent:rf_source_startofpacket -> timer_10ms_s1_agent_rsp_fifo:in_startofpacket
	wire         timer_10ms_s1_agent_rf_source_endofpacket;                                      // timer_10ms_s1_agent:rf_source_endofpacket -> timer_10ms_s1_agent_rsp_fifo:in_endofpacket
	wire         timer_10ms_s1_agent_rsp_fifo_out_valid;                                         // timer_10ms_s1_agent_rsp_fifo:out_valid -> timer_10ms_s1_agent:rf_sink_valid
	wire  [86:0] timer_10ms_s1_agent_rsp_fifo_out_data;                                          // timer_10ms_s1_agent_rsp_fifo:out_data -> timer_10ms_s1_agent:rf_sink_data
	wire         timer_10ms_s1_agent_rsp_fifo_out_ready;                                         // timer_10ms_s1_agent:rf_sink_ready -> timer_10ms_s1_agent_rsp_fifo:out_ready
	wire         timer_10ms_s1_agent_rsp_fifo_out_startofpacket;                                 // timer_10ms_s1_agent_rsp_fifo:out_startofpacket -> timer_10ms_s1_agent:rf_sink_startofpacket
	wire         timer_10ms_s1_agent_rsp_fifo_out_endofpacket;                                   // timer_10ms_s1_agent_rsp_fifo:out_endofpacket -> timer_10ms_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                          // cmd_mux_004:src_valid -> timer_10ms_s1_agent:cp_valid
	wire  [85:0] cmd_mux_004_src_data;                                                           // cmd_mux_004:src_data -> timer_10ms_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                          // timer_10ms_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                        // cmd_mux_004:src_channel -> timer_10ms_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                  // cmd_mux_004:src_startofpacket -> timer_10ms_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                    // cmd_mux_004:src_endofpacket -> timer_10ms_s1_agent:cp_endofpacket
	...
	wire  [86:0] timer_1ms_s1_agent_rf_source_data;                                              // timer_1ms_s1_agent:rf_source_data -> timer_1ms_s1_agent_rsp_fifo:in_data
	...
	wire  [86:0] timer_1ms_s1_agent_rsp_fifo_out_data;                                           // timer_1ms_s1_agent_rsp_fifo:out_data -> timer_1ms_s1_agent:rf_sink_data
	...
	wire  [85:0] cmd_mux_005_src_data;                                                           // cmd_mux_005:src_data -> timer_1ms_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                          // timer_1ms_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                        // cmd_mux_005:src_channel -> timer_1ms_s1_agent:cp_channel
	...
	wire  [85:0] sw_s1_agent_rp_data;                                                            // SW_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [85:0] led_s1_agent_rp_data;                                                           // LED_s1_agent:rp_data -> router_004:sink_data
	...
	wire         timer_10ms_s1_agent_rp_valid;                                                   // timer_10ms_s1_agent:rp_valid -> router_005:sink_valid
	wire  [85:0] timer_10ms_s1_agent_rp_data;                                                    // timer_10ms_s1_agent:rp_data -> router_005:sink_data
	wire         timer_10ms_s1_agent_rp_ready;                                                   // router_005:sink_ready -> timer_10ms_s1_agent:rp_ready
	wire         timer_10ms_s1_agent_rp_startofpacket;                                           // timer_10ms_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         timer_10ms_s1_agent_rp_endofpacket;                                             // timer_10ms_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [85:0] timer_1ms_s1_agent_rp_data;                                                     // timer_1ms_s1_agent:rp_data -> router_006:sink_data
	...
	wire         timer_10ms_s1_agent_rdata_fifo_src_valid;                                       // timer_10ms_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] timer_10ms_s1_agent_rdata_fifo_src_data;                                        // timer_10ms_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         timer_10ms_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_004:in_0_ready -> timer_10ms_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                              // avalon_st_adapter_004:out_0_valid -> timer_10ms_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                               // avalon_st_adapter_004:out_0_data -> timer_10ms_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                              // timer_10ms_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                              // avalon_st_adapter_004:out_0_error -> timer_10ms_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (pll_outclk1_clk),                                               //                      clk.clk
		.reset                  (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (timer_10ms_s1_agent_m0_address),                                // avalon_universal_slave_0.address
		.uav_burstcount         (timer_10ms_s1_agent_m0_burstcount),                             //                         .burstcount
		.uav_read               (timer_10ms_s1_agent_m0_read),                                   //                         .read
		.uav_write              (timer_10ms_s1_agent_m0_write),                                  //                         .write
		.uav_waitrequest        (timer_10ms_s1_agent_m0_waitrequest),                            //                         .waitrequest
		.uav_readdatavalid      (timer_10ms_s1_agent_m0_readdatavalid),                          //                         .readdatavalid
		.uav_byteenable         (timer_10ms_s1_agent_m0_byteenable),                             //                         .byteenable
		.uav_readdata           (timer_10ms_s1_agent_m0_readdata),                               //                         .readdata
		.uav_writedata          (timer_10ms_s1_agent_m0_writedata),                              //                         .writedata
		.uav_lock               (timer_10ms_s1_agent_m0_lock),                                   //                         .lock
		.uav_debugaccess        (timer_10ms_s1_agent_m0_debugaccess),                            //                         .debugaccess
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (pll_outclk1_clk),                                               //             clk.clk
		.reset                   (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (timer_10ms_s1_agent_m0_address),                                //              m0.address
		.m0_burstcount           (timer_10ms_s1_agent_m0_burstcount),                             //                .burstcount
		.m0_byteenable           (timer_10ms_s1_agent_m0_byteenable),                             //                .byteenable
		.m0_debugaccess          (timer_10ms_s1_agent_m0_debugaccess),                            //                .debugaccess
		.m0_lock                 (timer_10ms_s1_agent_m0_lock),                                   //                .lock
		.m0_readdata             (timer_10ms_s1_agent_m0_readdata),                               //                .readdata
		.m0_readdatavalid        (timer_10ms_s1_agent_m0_readdatavalid),                          //                .readdatavalid
		.m0_read                 (timer_10ms_s1_agent_m0_read),                                   //                .read
		.m0_waitrequest          (timer_10ms_s1_agent_m0_waitrequest),                            //                .waitrequest
		.m0_writedata            (timer_10ms_s1_agent_m0_writedata),                              //                .writedata
		.m0_write                (timer_10ms_s1_agent_m0_write),                                  //                .write
		.rp_endofpacket          (timer_10ms_s1_agent_rp_endofpacket),                            //              rp.endofpacket
		.rp_ready                (timer_10ms_s1_agent_rp_ready),                                  //                .ready
		.rp_valid                (timer_10ms_s1_agent_rp_valid),                                  //                .valid
		.rp_data                 (timer_10ms_s1_agent_rp_data),                                   //                .data
		.rp_startofpacket        (timer_10ms_s1_agent_rp_startofpacket),                          //                .startofpacket
		...
		.rf_sink_ready           (timer_10ms_s1_agent_rsp_fifo_out_ready),                        //         rf_sink.ready
		.rf_sink_valid           (timer_10ms_s1_agent_rsp_fifo_out_valid),                        //                .valid
		.rf_sink_startofpacket   (timer_10ms_s1_agent_rsp_fifo_out_startofpacket),                //                .startofpacket
		.rf_sink_endofpacket     (timer_10ms_s1_agent_rsp_fifo_out_endofpacket),                  //                .endofpacket
		.rf_sink_data            (timer_10ms_s1_agent_rsp_fifo_out_data),                         //                .data
		.rf_source_ready         (timer_10ms_s1_agent_rf_source_ready),                           //       rf_source.ready
		.rf_source_valid         (timer_10ms_s1_agent_rf_source_valid),                           //                .valid
		.rf_source_startofpacket (timer_10ms_s1_agent_rf_source_startofpacket),                   //                .startofpacket
		.rf_source_endofpacket   (timer_10ms_s1_agent_rf_source_endofpacket),                     //                .endofpacket
		.rf_source_data          (timer_10ms_s1_agent_rf_source_data),                            //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                             //                .error
		.rdata_fifo_src_ready    (timer_10ms_s1_agent_rdata_fifo_src_ready),                      //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (timer_10ms_s1_agent_rdata_fifo_src_valid),                      //                .valid
		.rdata_fifo_src_data     (timer_10ms_s1_agent_rdata_fifo_src_data),                       //                .data
		.m0_response             (2'b00),                                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) timer_10ms_s1_agent_rsp_fifo (
		.clk               (pll_outclk1_clk),                                               //       clk.clk
		.reset             (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (timer_10ms_s1_agent_rf_source_data),                            //        in.data
		.in_valid          (timer_10ms_s1_agent_rf_source_valid),                           //          .valid
		.in_ready          (timer_10ms_s1_agent_rf_source_ready),                           //          .ready
		.in_startofpacket  (timer_10ms_s1_agent_rf_source_startofpacket),                   //          .startofpacket
		.in_endofpacket    (timer_10ms_s1_agent_rf_source_endofpacket),                     //          .endofpacket
		.out_data          (timer_10ms_s1_agent_rsp_fifo_out_data),                         //       out.data
		.out_valid         (timer_10ms_s1_agent_rsp_fifo_out_valid),                        //          .valid
		.out_ready         (timer_10ms_s1_agent_rsp_fifo_out_ready),                        //          .ready
		.out_startofpacket (timer_10ms_s1_agent_rsp_fifo_out_startofpacket),                //          .startofpacket
		.out_endofpacket   (timer_10ms_s1_agent_rsp_fifo_out_endofpacket),                  //          .endofpacket
		.csr_address       (2'b00),                                                         // (terminated)
		.csr_read          (1'b0),                                                          // (terminated)
		.csr_write         (1'b0),                                                          // (terminated)
		.csr_readdata      (),                                                              // (terminated)
	...
	NIOS_LED_Qsys_mm_interconnect_1_router router (
	...
	NIOS_LED_Qsys_mm_interconnect_1_router_001 router_001 (
	...
	NIOS_LED_Qsys_mm_interconnect_1_router_001 router_002 (
	...
	NIOS_LED_Qsys_mm_interconnect_1_router_001 router_003 (
	...
	NIOS_LED_Qsys_mm_interconnect_1_router_001 router_004 (
	...
	NIOS_LED_Qsys_mm_interconnect_1_router_001 router_005 (
		.sink_ready         (timer_10ms_s1_agent_rp_ready),                                  //      sink.ready
		.sink_valid         (timer_10ms_s1_agent_rp_valid),                                  //          .valid
		.sink_data          (timer_10ms_s1_agent_rp_data),                                   //          .data
		.sink_startofpacket (timer_10ms_s1_agent_rp_startofpacket),                          //          .startofpacket
		.sink_endofpacket   (timer_10ms_s1_agent_rp_endofpacket),                            //          .endofpacket
		.clk                (pll_outclk1_clk),                                               //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_router_001 router_006 (
	...
	NIOS_LED_Qsys_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (pll_outclk1_clk),                                               //        clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (pll_outclk0_clk),                             //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (pll_outclk1_clk),                                               //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (pll_outclk1_clk),                                               //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (pll_outclk1_clk),                       //       clk.clk
		.reset               (LED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_cmd_mux cmd_mux_004 (
		.clk                 (pll_outclk1_clk),                                               //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_cmd_mux cmd_mux_005 (
		.clk                 (pll_outclk1_clk),                                               //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (pll_outclk0_clk),                             //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_rsp_demux_001 rsp_demux_001 (
		.clk                (pll_outclk1_clk),                                               //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_rsp_demux_001 rsp_demux_002 (
		.clk                (pll_outclk1_clk),                                               //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_rsp_demux_001 rsp_demux_003 (
		.clk                (pll_outclk1_clk),                       //       clk.clk
		.reset              (LED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_rsp_demux_001 rsp_demux_004 (
		.clk                (pll_outclk1_clk),                                               //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_rsp_demux_001 rsp_demux_005 (
		.clk                (pll_outclk1_clk),                                               //       clk.clk
		.reset              (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (pll_outclk1_clk),                                               //       clk.clk
		.reset               (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_LED_Qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_outclk1_clk),                                               // in_clk_0.clk
		.in_rst_0_reset (mm_clock_crossing_bridge_m0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (timer_10ms_s1_agent_rdata_fifo_src_data),                       //     in_0.data
		.in_0_valid     (timer_10ms_s1_agent_rdata_fifo_src_valid),                      //         .valid
		.in_0_ready     (timer_10ms_s1_agent_rdata_fifo_src_ready),                      //         .ready
