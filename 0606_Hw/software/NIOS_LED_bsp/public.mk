...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../NIOS_LED_Qsys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is NIOS_LED_Qsys
SOPC_NAME := NIOS_LED_Qsys
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1000068
SOPC_SYSID_FLAG += --sidp=0x1000068
ELF_PATCH_FLAG  += --sidp 0x1000068

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1655102908
SOPC_SYSID_FLAG += --timestamp=1655102908
ELF_PATCH_FLAG  += --timestamp 1655102908
